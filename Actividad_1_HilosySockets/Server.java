		...
		while (true) {
			...
			try {
				...
				case 1:
					...
					toReturn = "El precio establecido para una landing page es de 600€ + IVA.";
				...
				case 2:
					...
					toReturn = "El precio establecido para una página web de empresa es de 800€ + IVA.";
				...
				case 3:
					...
					toReturn = "El precio establecido para un ecommerce es de 1400€ + IVA.";
				...
				case 4:
					...
					toReturn = "Según el tipo de sitio web que escojas, el tiempo de duración será:"
				...
				case 5:
					...
					toReturn = "Las formas de pago serán:" + "\nTransferencia a cuenta." + "\nTarjeta de Crédito."
							+ "\nPaypal.\n"
				...
				default:
					...
					dataOut.writeUTF("Por favor, seleccione una opción válida [1 a 6].");
